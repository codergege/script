...
pwdDir=$pwd
# eclipse 
url=http://mirrors.neusoft.edu.cn/eclipse/technology/epp/downloads/release/neon/1a/eclipse-java-neon-1a-linux-gtk.tar.gz
pkg=eclipse-java-neon-1a-linux-gtk.tar.gz
